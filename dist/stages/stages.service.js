...
let StagesService = class StagesService {
    constructor(stageModel, raceModel) {
...
StagesService = __decorate([
    ...
    __param(1, common_1.Inject('RACE_MODEL')),
